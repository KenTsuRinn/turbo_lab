...
class TwittersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create twitter" do
    assert_difference('Twitter.count') do
      post twitters_url, params: { twitter: { content: @twitter.content, dislike: @twitter.dislike, like: @twitter.like, user: @twitter.user } }
    end
  ...
  test "should update twitter" do
    patch twitter_url(@twitter), params: { twitter: { content: @twitter.content, dislike: @twitter.dislike, like: @twitter.like, user: @twitter.user } }
